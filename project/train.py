...
def main():
    ...
    parser.add_argument(
        "config_file_name", help="e.g. mountaincarcontinuous_easy", type=str
    )
    parser.add_argument("seed", help="e.g. 4", type=int)
    args = parser.parse_args()

    # TODO: Get config_file_name from command argument.
    # e.g. MountainCarContinuous-v0
    config_file_name = args.config_file_name
    seed = args.seed

    cfg = create_env(config_file_name, seed)
